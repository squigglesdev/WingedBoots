...
public class Items {
    ...
    public static final Item WINGED_BOOTS = new HoverBootsItem(HOVER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings());
    ...
    public static final Item CLOUD_BOTTLE = new CloudBottleItem(new Item.Settings().maxCount(1));
    ...
    public static void registerItems() {
        Registry.register(Registries.ITEM, new Identifier(WingedBoots.MODID, "winged_boots"), WINGED_BOOTS);
